...
import { Server, Wifi, ShieldAlert, Lock, Unlock, Database, Globe, Smartphone, Activity, Crosshair, Binary, Maximize2, Minimize2, Cpu, Blocks } from 'lucide-react';
...
const TargetMainIcon = ({ type, size, className }: { type: string, size: number, className?: string }) => {
   switch (type) {
    ...
    case TargetType.BLOCKCHAIN: return <Blocks size={size} className={className} />;
